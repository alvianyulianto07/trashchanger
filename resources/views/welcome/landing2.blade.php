			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="navbarTogglerDemo01">
					<div class="d-lg-none d-flex justify-content-between px-4 py-3 align-items-center">
						<img src="{{asset('assets/landing/images/logo-dark.svg')}}" class="logo-mobile-menu" alt="logo">
					...
					<ul class="navbar-nav ml-auto align-items-center">
						...
						<li class="nav-item">
							<a class="nav-link btn btn-success" href="#contact">Login</a>
						</li>
					</ul>
				</div>
			</div>
							...
							<div class="main-banner">
								<div class="d-sm-flex justify-content-between">
									...
									<div class="mt-5 mt-lg-0">
										<img src="{{asset('assets/landing/images/group.png')}}" alt="marsmello" class="img-fluid" data-aos="zoom-in-up">
									</div>
								</div>
							</div>
						</div>
					...
					<div class="row">
						<div class="col-sm-6" data-aos="fade-up">
							...
							<div class="d-flex justify-content-start mb-3">
								<img src="{{asset('assets/landing/images/tick.png')}}" alt="tick" class="mr-3 tick-icon"  >
					...
					<div class="row" data-aos="fade-up">
						<div class="col-sm-3 text-center">
							<div class="services-box" data-aos="fade-down" data-aos-easing="linear" data-aos-duration="1500">
								<img src="{{asset('assets/landing/images/integrated-marketing.svg')}}" alt="integrated-marketing" data-aos="zoom-in">
						...
						<div class="col-sm-3 text-center">
							<div class="services-box"   data-aos="fade-down" data-aos-easing="linear" data-aos-duration="1500">
								<img src="{{asset('assets/landing/images/design-development.svg')}}" alt="design-development" data-aos="zoom-in">
						...
						<div class="col-sm-3 text-center">
							<div class="services-box" data-aos="fade-down" data-aos-easing="linear" data-aos-duration="1500">
								<img src="{{asset('assets/landing/images/digital-strategy.svg')}}" alt="digital-strategy" data-aos="zoom-in">
								<h6 class="text-dark mb-3 mt-4 font-weight-medium">Terintegrasi
								</h6>
								<p>Data bank sampah yang tergabung sudah terintegrasi sehingga memudahkan pemantauan pengelolaan sampah.
								</p>
							</div>
						</div>
                        <div class="col-sm-3 text-center">
							<div class="services-box  pb-lg-0" data-aos="fade-down" data-aos-easing="linear" data-aos-duration="1500">
								<img src="{{asset('assets/landing/images/digital-marketing.svg')}}" alt="digital-marketing" data-aos="zoom-in">
					...
					<div class="row pt-5 mt-5 pb-5 mb-5">
						<div class="col-sm-3">
							<div class="d-flex py-3 my-3 my-lg-0 justify-content-center" data-aos="fade-down">
								<img src="{{asset('assets/landing/images/satisfied-client.svg')}}" alt="satisfied-client" class="mr-3">
								<div>
						...
						<div class="col-sm-3">
							<div class="d-flex py-3 my-3 my-lg-0 justify-content-center" data-aos="fade-up">
								<img src="{{asset('assets/landing/images/finished-project.svg')}}" alt="satisfied-client" class="mr-3">
								<div>
						...
						<div class="col-sm-3">
							<div class="d-flex py-3 my-3 my-lg-0 justify-content-center" data-aos="fade-down">
								<img src="{{asset('assets/landing/images/team-members.svg')}}" alt="Team Members" class="mr-3">
								<div>
						...
						<div class="col-sm-3">
							<div class="d-flex py-3 my-3 my-lg-0 justify-content-center" data-aos="fade-up">
								<img src="{{asset('assets/landing/images/our-blog-posts.svg')}}" alt="Our Blog Posts" class="mr-3">
								<div>
				...
				<div class="container">
					<div class="d-flex justify-content-between align-items-center">
						<div class="d-flex align-items-center">
							...
							<p class="mb-0 text-small pt-1">© 2022 <a href="#" class="text-white" target="_blank">TrashChanger</a>. All rights reserved.</p>
						</div>
						<div>
							<div class="d-flex">
