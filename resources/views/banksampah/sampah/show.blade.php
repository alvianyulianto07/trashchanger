        ...
        <form action="" method="POST" enctype="multipart/form-data">
            ...
            <div class="m-4">
                <div class="row pl-0 pr-0">
                    <div class="font-form-header mb-3 col-6">Detail Sampah</div>
                    <div class="font-form-header mb-3 col-6 d-flex justify-content-end">
                        <a href="{{ route('sampah.index') }}" class="btn btn-primary btn-sm mr-3" style="margin-right: 5px;"><i
                                class="fas fa-arrow-left mr-2"></i>Kembali</a>
                        <a href="{{ route('sampah.edit', $sampah->id) }}" class="btn btn-primary btn-sm" ><i
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="mb-3 row align-items-center">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="nama_sampah" value="{!! $sampah->nama_sampah !!}" required="required"
                                    class="form-control"
                        ...
                        <div class="mb-3 row align-items-center">
                            <label for="inputJumlah"  class="col-sm-2 col-form-label font-form">Jumlah</label>
                                <div class="col-sm-10 col-form-label">
                                    <input type="number" name="jumlah" value="{!! $sampah->jumlah !!}" required="required" class="form-control form-control-size" placeholder="Masukkan Jumlah Sampah" id="jumlah" readonly>
                                </div>
                        </div>
                        <div class="mb-3 row align-items-center">
                            <label for="inputHarga"  class="col-sm-2 col-form-label font-form">Harga</label>
                                <div class="col-sm-10 col-form-label">
                                    <input type="text" name="harga" value="Rp. {{ number_format($sampah->harga, 0, ',', '.');}}" required="required" class="form-control form-control-size" placeholder="Masukkan Harga Sampah" id="harga" readonly>
                                </div>
                        </div>
                        <div class="mb-3 row align-items-center">
